...
<%@page import="com.orcale.tea.model.daoImp.productDAOImp"%>
...
<!--内页样式-->
 ...
 <div class="p_list  clearfix">
   <ul id="ajaxTea">
    <c:forEach  var="t"  items="${requestScope.allproduct }" varStatus="s">
     <li class="gl-item">
	<div class="Borders">
	 <div class="img"><a href="productServlet?method=detail&teaid=${t.teaid }"><img src="${t.mainimag }" style="width:220px;height:220px"/></a></div>	 
	 <div class="name"><a href="productServlet?method=detail&teaid=${t.teaid }">${t.teaname }</a></div>
     <div class="Price">商城价：<b>¥${t.shangchengjia }</b><span>原价：<em>¥${t.yuanjia }</em></span></div>
	 <div class="Review">已有<a href="#">2345</a>评论</div>
	 <div class="p-operate">
	  <a href=" #" class="p-o-btn Collect"><em></em>收藏</a>
	  <a href="shoppingCarServlet?method=add&teaid=${t.teaid }" class="p-o-btn shop_cart"><em></em>加入购物车</a>
	 </div>
	 </div>
	</li>
    </c:forEach>
  ...
  <div style="width: 100%;margin: auto;text-align: center;">
						...
						<a  href="productServlet?method=listproductByPage&page=1&count=15"  class="pages">首页</a>
						<a  href="productServlet?method=listproductByPage&page=${requestScope.pageBean.previousPage}&count=15"  class="pages">上一页</a>
						<a  href="productServlet?method=listproductByPage&page=${requestScope.pageBean.nextPage}&count=15"  class="pages">下一页</a>
						<a  href="productServlet?method=listproductByPage&page=${requestScope.pageBean.allPages}&count=15"  class="pages">尾页</a>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				$("#goto").change(function(){
					location.href='productServlet?method=listproductByPage&page='+$(this).val()+'&count=15';//用js发起请求
				})
			})
		</script>
</body>
