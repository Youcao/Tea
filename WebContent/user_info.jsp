  ...
  <div class="clearfix user" >
    ...
    <div class=" right_style r_user_style">
      <div class="user_Borders">
       ...
       <form id="form" name="form" method="post" action="UserServlet" enctype="multipart/form-data"> 
       <input  type="hidden"  name="userid"  value="${user.userid }"/>  
       <div class="user_layout">
         <ul >
          <li><label class="user_title_name">用户头像：</label><input type="file"  name="headImage" /></li>
          <li><label class="user_title_name">用户昵称：</label><input name="nickname" value="${user.nickname }" type="text"  class="add_text"/><i>*</i></li>
          <li><label class="user_title_name">真实姓名：</label><input name="xingmiang" value="${user.xingmiang }" type="text"  class="add_text"/><i>*</i></li>
          ...
          <li><label class="user_title_name">手&nbsp;机&nbsp;号：</label><input name="phonenumber" value="${user.phonenumber }" type="text"  class="add_text"/><i>*</i></li>
          <li><label class="user_title_name">邮箱地址：</label><input name="email" value="${user.email }" type="text"  class="add_text"/><i>*</i></li>         
         </ul>
