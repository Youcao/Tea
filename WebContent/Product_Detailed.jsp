...
<%  product  productInfo=(product)request.getAttribute("product"); %>
  ...
  <div class="mod_picfold clearfix">
    <div class="clearfix" id="detail_main_img">
     ...
     <div id="vertical" class="bigImg">
		<img src="<%=productInfo.getMainimag() %>" width="" height="" alt="" id="midimg" />
  ...
  <!--收藏-->
   ...
   <!--信息样式-->
    ...
    <form action="javascript:addToCart(97)" name="ECS_FORMBUY" id="ECS_FORMBUY">
	  <div class="title"><h1><%=productInfo.getTeaname() %></h1><p><%=productInfo.getChandi() %></p></div>
	  <div class="mod_detailInfo_priceSales">
	  <div class="margins">
	  <div class="Price clearfix text_name"><label>价格</label><span class="Prices"><h4>¥<%=productInfo.getYuanjia() %></h4> <b><%=productInfo.getShangchengjia() %></b></span></div>
	  <div class="Activity clearfix text_name"><label>重量</label><span class="weight"><%=productInfo.getZhongliang() %></span></div>
      <div class="Size clearfix text_name"><label>规格</label><a href="#"><%=productInfo.getGuige() %></a><a href="#">礼盒装</a><a href="#">铁盒</a></div>
      <div class="Sales_volume">
       <div class="Sales_info"><h5>销量</h5><b><%=productInfo.getYouxiaoqi() %></b></div>
      </div>
	  </div>
	  <div class="s_Review">
	 ...
	 <div class="buyinfo" id="detail_buyinfo">
	  ...
	  <dd>
	    <div class="wrap_btn"> <a id="shoppingcar"  href="shoppingCarServlet?method=add&teaid=<%=productInfo.getTeaid()%>" class="wrap_btn1" title="加入购物车"></a> 
